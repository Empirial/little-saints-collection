...
const slides: CarouselSlide[] = [
  ...
  },
  {
    ...
    description: "High-quality A4 posters printed on 350gsm paper, perfect for any child's space",
  ...
  },
  {
    ...
    description: "Create custom storybooks where your child becomes part of the Biblical adventure",
