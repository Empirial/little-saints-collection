        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="space-y-3 mb-4">
              <Button onClick={handleAddToCart} className="w-full font-fredoka text-xl py-7 rounded-full shadow-xl hover:shadow-2xl transition-all" size="lg">
              ...
              <Button
                ...
                variant="outline"
                className="w-full font-fredoka text-lg py-6 rounded-full border-2 hover:bg-muted/50"
                size="lg"
              >
                Proceed to Checkout
